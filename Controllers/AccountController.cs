...
namespace MsalAndGraphSdk.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        // テナント ID
        public static readonly string GraphTenantId = "b9478444-dadb-404f-91b7-6ec788c43db5";
        // アプリケーション ID
        public static readonly string GraphClientId = "d20bad37-4a51-496f-8879-33f140234cdf";
        // アプリケーション シークレット
        public static readonly string GraphClientSecret = "aGzF1ESk1gKP7UU[=dE-XGhB]Uo3P1r=";
        // スコープ
